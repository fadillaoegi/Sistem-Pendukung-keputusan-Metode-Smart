...
?>
            ...
            <div style="background-color: #2c3e50;" id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 style="color: #ecf0f1;" class="page-header">Data Alternatif</h1>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?=$siswa['kelas']?></td>
                                                    <td><?=$siswa['siswa']?></td>
                                                    <td><a class="btn btn-danger" onclick="return confirm('Apakah yakin menghapus ?')" href='aksi/hapusa.php?name=<?=$siswa['nisn'];?>'>hapus</a></td>
                                                </tr>
                                                <?php
                                                    $n++;
                                                    }
